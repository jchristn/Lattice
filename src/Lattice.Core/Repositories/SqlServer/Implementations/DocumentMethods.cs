namespace Lattice.Core.Repositories.SqlServer.Implementations
{
    ...
    internal class DocumentMethods : IDocumentMethods
    {
        ...
        internal DocumentMethods(SqlServerRepository repo)
        {
        ...
        public async Task<Document> Create(Document document, CancellationToken token = default)
        {
            ...
            string query = $@"
                ...
                VALUES ('{Sanitizer.Sanitize(document.Id)}',
                        ...
                        {(document.Name != null ? $"N'{Sanitizer.Sanitize(document.Name)}'" : "NULL")},
        ...
        public async Task<Document> Update(Document document, CancellationToken token = default)
        {
            ...
            string query = $@"
                UPDATE [documents] SET
                    [name] = {(document.Name != null ? $"N'{Sanitizer.Sanitize(document.Name)}'" : "NULL")},
