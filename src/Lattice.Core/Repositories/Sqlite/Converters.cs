    ...
    internal static class Converters
    {
        ...
        internal static Tenant TenantFromDataRow(DataRow row)
        {
            ...
            return new Tenant
            {
                ...
                Active = Convert.ToInt32(row["active"]) != 0,
                IsProtected = Convert.ToInt32(row["isprotected"]) != 0,
                CreatedUtc = DateTime.Parse(row["createdutc"].ToString()),
                LastUpdateUtc = DateTime.Parse(row["lastupdateutc"].ToString())
            };
        }
        ...
        internal static User UserFromDataRow(DataRow row)
        {
            ...
            return new User
            {
                ...
                IsAdmin = Convert.ToInt32(row["isadmin"]) != 0,
                IsTenantAdmin = Convert.ToInt32(row["istenantadmin"]) != 0,
                Active = Convert.ToInt32(row["active"]) != 0,
                IsProtected = Convert.ToInt32(row["isprotected"]) != 0,
                CreatedUtc = DateTime.Parse(row["createdutc"].ToString()),
                LastUpdateUtc = DateTime.Parse(row["lastupdateutc"].ToString())
        ...
        internal static Credential CredentialFromDataRow(DataRow row)
        {
            ...
            return new Credential
            {
                ...
                LastUsedUtc = row["lastusedutc"] != DBNull.Value ? DateTime.Parse(row["lastusedutc"].ToString()) : (DateTime?)null,
                Active = Convert.ToInt32(row["active"]) != 0,
                IsProtected = Convert.ToInt32(row["isprotected"]) != 0,
                CreatedUtc = DateTime.Parse(row["createdutc"].ToString()),
                LastUpdateUtc = DateTime.Parse(row["lastupdateutc"].ToString())
        ...
        internal static AuthSession AuthSessionFromDataRow(DataRow row)
        {
            ...
            return new AuthSession
            {
                ...
                ExpiresUtc = DateTime.Parse(row["expiresutc"].ToString()),
                LastUsedUtc = row["lastusedutc"] != DBNull.Value ? DateTime.Parse(row["lastusedutc"].ToString()) : (DateTime?)null,
                RevokedUtc = row["revokedutc"] != DBNull.Value ? DateTime.Parse(row["revokedutc"].ToString()) : (DateTime?)null,
        ...
        internal static UserRole UserRoleFromDataRow(DataRow row)
        {
            ...
            return new UserRole
            {
                ...
                Name = row["name"]?.ToString(),
                IsBuiltIn = Convert.ToInt32(row["isbuiltin"]) != 0,
                Active = Convert.ToInt32(row["active"]) != 0,
                IsProtected = Convert.ToInt32(row["isprotected"]) != 0,
                CreatedUtc = DateTime.Parse(row["createdutc"].ToString()),
                LastUpdateUtc = DateTime.Parse(row["lastupdateutc"].ToString())
        ...
        internal static UserRoleAssignment UserRoleAssignmentFromDataRow(DataRow row)
        {
            ...
            return new UserRoleAssignment
            {
                ...
                InheritsToChildren = Convert.ToInt32(row["inheritstochildren"]) != 0,
                Active = Convert.ToInt32(row["active"]) != 0,
                CreatedUtc = DateTime.Parse(row["createdutc"].ToString()),
                LastUpdateUtc = DateTime.Parse(row["lastupdateutc"].ToString())
            };
