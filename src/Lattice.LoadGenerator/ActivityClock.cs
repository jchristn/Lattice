namespace Lattice.LoadGenerator
{
    ...
    /// modulated by a diurnal curve (busy working hours, quiet nights) plus random bursts, so seeded
    /// activity looks like an in-use system rather than a uniform sweep. Not thread-safe.
    /// </summary>
    public class ActivityClock
    {
        #region Public-Members

        /// <summary>Inclusive start of the activity window, in UTC.</summary>
        ...
        /// <summary>Exclusive end of the activity window, in UTC.</summary>
        ...
        /// <summary>
        /// Generate a sorted list of organic timestamps within the window. Most samples follow the diurnal
        /// curve; a fraction cluster around random burst centers.
        /// </summary>
        ...
        /// <summary>Generate a single organic timestamp within the window.</summary>
